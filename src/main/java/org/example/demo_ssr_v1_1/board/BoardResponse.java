...
public class BoardResponse {
    ...
    public static class PageDTO {
        ...
        private boolean empty;          // 게시글이 한 건도 없는가? (Mustache에서 페이징 영역 가리기 용)
        ...
        public PageDTO(Page<Board> page) {
            ...
            // [중요] Mustache 명세는 숫자 0을 falsy로 취급하지 않는다.
            //        ({{#totalElements}} 로 빈 결과를 가리려고 하면 안 가려진다)
            //        그래서 boolean 필드로 명시적으로 담아 둔다.
